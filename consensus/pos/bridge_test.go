...
// 	"github.com/thrylos-labs/go-thrylos/config"     // Added
// 	"github.com/thrylos-labs/go-thrylos/core/state" // Added
...
// 	engine := setupTestEngine(b.(*testing.T))
// 	mockNetwork := NewMockP2PNetwork()
