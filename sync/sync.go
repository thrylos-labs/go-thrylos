...
// sync/sync.go - Main synchronization coordinator
import (
	"context"
	"fmt"
	"sync"
...
type SyncManager struct {
	...
	p2pNetwork   *network.P2PNetwork // Use concrete type, not interface
	synchronizer *Synchronizer       // Reference types in same package
	stateSyncer  *StateSyncer        // Reference types in same package
